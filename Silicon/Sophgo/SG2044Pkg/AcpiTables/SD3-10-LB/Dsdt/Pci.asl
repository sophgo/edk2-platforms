  ...
  Device (PCI0)
  {
    ...
    Device (RES0)
    {
      ...
      Name (_CRS, ResourceTemplate ()  // _CRS: Current Resource Settings
      {
        ...
        QWordMemory ( // config
          // Relocated below 4G (was 0x40_00000000) to free the 128G C2C0
          // aperture for a single prefetchable BAR. 4K window + iATU.
          ResourceProducer, PosDecode,
          MinFixed, MaxFixed,
          NonCacheable, ReadWrite,
          0x0000000000,                       // Granularity
          0x0040000000,                       // Range Minimum
          0x004FFFFFFF,                       // Range Maximum
          0x0000000000,                       // Translation Offset
          0x0010000000,                       // Length
          , , , AddressRangeMemory, TypeStatic)
