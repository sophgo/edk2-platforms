...
STATIC CONST BOARD_SLOT  mSrm370Slots[] = {
  ...
  { 2, { 0x00 }, 1, 1, SlotTypePCIExpressGen5X8, "PCIE1", SlotDataBusWidth8X, 8, SlotDataBusWidth8X, SlotLengthLong, SlotHeightFullHeight, 5, 0x04, 0x04, 0 },
  ...
  { 6, { 0x00 }, 1, 4, SlotTypeOther, "MCIO1A", SlotDataBusWidth4X, 4, SlotDataBusWidth4X, SlotLengthUnknown, SlotHeightNone, 0, 0x04, 0x04, 0 },
  { 7, { 0x00 }, 1, 7, SlotTypeOther, "MCIO1B", SlotDataBusWidth4X, 4, SlotDataBusWidth4X, SlotLengthUnknown, SlotHeightNone, 0, 0x04, 0x04, 0 },
