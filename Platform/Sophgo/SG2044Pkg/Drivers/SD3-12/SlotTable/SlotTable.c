...
STATIC CONST BOARD_SLOT  mSd312Slots[] = {
  ...
  { 0, { 0x00 }, 1, 3, SlotTypePCIExpressGen5X16, "PCIE3", SlotDataBusWidth8X, SlotDataBusWidth16X, SlotLengthLong, SlotHeightFullHeight, 5, 0x04, 0x04, 0 },
  { 2, { 0x00 }, 1, 1, SlotTypePCIExpressGen5X16, "PCIE1", SlotDataBusWidth8X, SlotDataBusWidth16X, SlotLengthLong, SlotHeightFullHeight, 5, 0x04, 0x04, 0 },
  ...
  { 6, { 0x00 }, 1, 4, SlotTypeOther, "MCIO1", SlotDataBusWidth8X, SlotDataBusWidth8X, SlotLengthUnknown, SlotHeightNone, 0, 0x04, 0x04, 0 },
