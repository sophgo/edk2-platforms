...
SMBIOS_PLATFORM_DXE_TABLE_FUNCTION (PlatformSystem) {
  ...
  while (InputData->Hdr.Type != NULL_TERMINATED_TYPE) {
    ...
    if (SearchValueBySectionAndName ("product", "manufacturer", value) == 0) {
