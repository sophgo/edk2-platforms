...
#define CONF_FILE_NAME      L"conf.ini"
#define LABEL_FRONTPAGE_INFORMATION  0x1000
#define LABEL_END                    0xffff
#define LABEL_UPDATE_START	0x1000
#define LABEL_UPDATE_END	  0xffff
...
typedef struct {
    CHAR8  Key[MAX_NAME_LENGTH];     
    CHAR8  Value[MAX_VALUE_LENGTH];      
} CONFIG_ENTRY;

typedef struct {
    CHAR8  SectionName[MAX_SECTION_LENGTH]; 
...
typedef struct {
    UINTN SectionCount;
    CONFIG_SECTION Sections[MAX_SECTIONS];
} PARSED_INI_DATA;
