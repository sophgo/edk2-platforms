...
STATIC CONST BOARD_SLOT  mSrm370Slots[] = {
  ...
  { 0, { 0x00 }, 1, 3, SlotTypePCIExpressGen5X4, "PCIE3A", SlotDataBusWidth4X, SlotDataBusWidth4X },
  { 1, { 0x00 }, 1, 6, SlotTypePCIExpressGen5X4, "PCIE3B", SlotDataBusWidth4X, SlotDataBusWidth4X },
  { 2, { 0x00 }, 1, 1, SlotTypePCIExpressGen5X8, "PCIE1", SlotDataBusWidth8X, SlotDataBusWidth8X },
  ...
  { 6, { 0x00 }, 1, 4, SlotTypeOther, "MCIO1A", SlotDataBusWidth4X, SlotDataBusWidth4X },
  { 7, { 0x00 }, 1, 7, SlotTypeOther, "MCIO1B", SlotDataBusWidth4X, SlotDataBusWidth4X },
