...
SMBIOS_PLATFORM_DXE_TABLE_FUNCTION (PlatformBoard) {
  ...
  while (InputData->Hdr.Type != NULL_TERMINATED_TYPE) {
    ...
    if (SearchValueBySectionAndName ("board", "name", value) == 0) {
