...
Scope(_SB)
{
  ...
  Device (RESP)  //reserve for ecam resource
  {
    ...
    Name (_CRS, ResourceTemplate (){
      // ECAM space for PCI0 [bus 0x00-0xFF]
      QWordMemory (
        ResourceProducer, PosDecode,
        MinFixed, MaxFixed,
        NonCacheable, ReadWrite,
      ...
      // ECAM space for PCI1 [bus 0x00-0xFF]
      QWordMemory (
        ResourceProducer, PosDecode,
        MinFixed, MaxFixed,
        NonCacheable, ReadWrite,
      ...
      // ECAM space for PCI2 [bus 0x00-0xFF]
      QWordMemory (
        ResourceProducer, PosDecode,
        MinFixed, MaxFixed,
        NonCacheable, ReadWrite,
      ...
      // ECAM space for PCI3 [bus 0x00-0xFF]
      QWordMemory (
        ResourceProducer, PosDecode,
        MinFixed, MaxFixed,
        NonCacheable, ReadWrite,
      ...
      // ECAM space for PCI4 [bus 0x00-0xFF]
      QWordMemory (
        ResourceProducer, PosDecode,
        MinFixed, MaxFixed,
        NonCacheable, ReadWrite,
