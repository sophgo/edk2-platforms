  ...
  )
{
  ...
  for (BmcChannel = IPMI_CHANNEL_NUMBER_IMPLEMENTATION_SPECIFIC_1; BmcChannel < IPMI_CHANNEL_NUMBER_IMPLEMENTATION_SPECIFIC_11; BmcChannel++) {
    Status = IpmiSetBmcLanIpSrc (BmcChannel, pAddrSrc);
    if ( EFI_ERROR (Status) ) {
      continue;
    }
    break;
  ...
  )
{
  ...
  for (BmcChannel = IPMI_CHANNEL_NUMBER_IMPLEMENTATION_SPECIFIC_1; BmcChannel < IPMI_CHANNEL_NUMBER_IMPLEMENTATION_SPECIFIC_11; BmcChannel++) {
    Status = IpmiSetBmcLanIpAddr (BmcChannel, BmcIpAddress);
    if ( EFI_ERROR (Status) ) {
      continue;
    }
    break;
  ...
  )
{
  ...
  for (BmcChannel = IPMI_CHANNEL_NUMBER_IMPLEMENTATION_SPECIFIC_1; BmcChannel < IPMI_CHANNEL_NUMBER_IMPLEMENTATION_SPECIFIC_11; BmcChannel++) {
    Status = IpmiSetBmcLanSubnetMask (BmcChannel, BmcSubnetMask);
    if ( EFI_ERROR (Status) ) {
      continue;
    }
    break;
  ...
  )
{
  ...
  for (BmcChannel = IPMI_CHANNEL_NUMBER_IMPLEMENTATION_SPECIFIC_1; BmcChannel < IPMI_CHANNEL_NUMBER_IMPLEMENTATION_SPECIFIC_11; BmcChannel++) {
    Status = IpmiSetBmcLanGateWay (BmcChannel, BmcDefaultGateWay);
    if ( EFI_ERROR (Status) ) {
      continue;
    }
    break;
